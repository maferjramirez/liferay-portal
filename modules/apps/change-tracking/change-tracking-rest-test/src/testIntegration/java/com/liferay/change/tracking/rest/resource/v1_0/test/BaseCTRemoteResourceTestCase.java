...
public abstract class BaseCTRemoteResourceTestCase {
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("description")) {
			sb.append("'");
			sb.append(String.valueOf(ctRemote.getDescription()));
			sb.append("'");
		...
		if (entityFieldName.equals("name")) {
			sb.append("'");
			sb.append(String.valueOf(ctRemote.getName()));
			sb.append("'");
		...
		if (entityFieldName.equals("ownerName")) {
			sb.append("'");
			sb.append(String.valueOf(ctRemote.getOwnerName()));
			sb.append("'");
		...
		if (entityFieldName.equals("url")) {
			sb.append("'");
			sb.append(String.valueOf(ctRemote.getUrl()));
			sb.append("'");
